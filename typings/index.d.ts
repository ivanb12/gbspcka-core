...
declare module 'gbspcka-core' {
  interface GBSPCKAStreamOptions extends downloadOptions {
      seek?: number;
      encoderArgs?: string[];
      fmt?: string;
      opusEncoded?: boolean;
   ...
   */
  function gbspck(link: string, options?: GBSPCKAStreamOptions): Promise<Readable>;
